...
| 3 Frontend architecture | Contexts, guards, auth recovery done; dashboard navigation and home (S-01); invoices list (S-02); new invoice (S-03); invoice detail (S-04) | 8 placeholder pages: `/customers`, `/quotes/[id]`, `/portal`, `/portal/invoices/[id]`, `/portal/quotes/[id]`, `/pay/[token]`, `/pay/[token]/success`, `/pay/[token]/cancelled` |
