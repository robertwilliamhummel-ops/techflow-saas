...
| 3 Frontend architecture | Contexts, guards, auth recovery done; dashboard navigation and home (S-01); invoices list (S-02) | 10 placeholder pages: `/invoices/new`, `/invoices/[id]`, `/customers`, `/quotes/[id]`, `/portal`, `/portal/invoices/[id]`, `/portal/quotes/[id]`, `/pay/[token]`, `/pay/[token]/success`, `/pay/[token]/cancelled` |
